...
# OUTPUT: 
# `results/Cohort_FindMarkers_DARs_genomic_annotated.rds`
...
# load data ----
input <- readRDS(here("data", "FindMarkers_DARs.rds"))
...
saveRDS(annotated.genomic.tib, here("results", "Cohort2_FindMarkers_DARs_genomic_annotated.rds"))
